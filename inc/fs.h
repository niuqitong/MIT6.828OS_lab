...
struct File {
	...
	uint32_t f_direct[NDIRECT];	// stores number of direct blocks, e.g., 1, 2, 4, 5, 7, 18, 29
	uint32_t f_indirect;		// indirect block, block number of the block that stores 
								// the block numbers of indirect blocks
